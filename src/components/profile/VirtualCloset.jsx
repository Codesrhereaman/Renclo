...
export default function VirtualCloset() {
  ...
  return (
    <div className="bg-white rounded-[32px] p-6 md:p-10 shadow-lg border border-gray-100">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
        ...
        <button className="px-6 py-3 bg-gray-900 text-white font-bold rounded-xl hover:bg-purple-600 transition-colors flex items-center gap-2 shadow-lg hover:-translate-y-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {MOCK_CLOSET.filter(item => activeTab === 'all' || item.occasion === activeTab).map((item, idx) => (
          <motion.div 
            key={item.id}
