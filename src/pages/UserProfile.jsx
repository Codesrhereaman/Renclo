...
import {
  User, Mail, Phone, Calendar, Edit2, Save, X, LogOut, ArrowLeft, CheckCircle, AlertCircle, ShoppingBag, MapPin, Sparkles, Settings
} from "lucide-react";
      ...
      <main className="flex-1 py-12 px-4 sm:px-6 lg:px-8 w-full max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="w-full lg:w-64 flex-shrink-0 flex flex-col gap-2">
            {[
              ...
              <button
                ...
                className={`flex items-center gap-3 px-5 py-4 rounded-xl font-bold transition-all text-left w-full ${
                  activeTab === tab.id
          ...
          <div className="flex-1">
            {activeTab === 'profile' && (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 animate-fade-in">
                ...
                {!isEditing ? (
                  <div className="animate-fade-in">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                      <div className="p-5 bg-slate-50 border border-gray-100 rounded-xl flex flex-col justify-center overflow-hidden">
                        ...
                        <p className="text-lg text-gray-900 font-bold truncate" title={user.phone}>{user.phone || "Not provided"}</p>
                      </div>
                  ...
                  <form onSubmit={handleSaveProfile} className="animate-fade-in tracking-tight">
            ...
            {activeTab === 'closet' && (
               <div className="animate-fade-in bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8">
                  <VirtualCloset />
               </div>
            )}
